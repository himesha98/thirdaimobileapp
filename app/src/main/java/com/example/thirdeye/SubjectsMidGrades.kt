...
class SubjectsMidGrades : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_subjects_mid_grades)
        grade = intent?.getStringExtra("grade").toString()
        textToSpeech = TextToSpeech(this@SubjectsMidGrades, this@SubjectsMidGrades)
        ...
        buddism = findViewById(R.id.buddism)
    ...
    private fun speakOUt() {
        textToSpeech.speak(
            "This is your subject list simply say which subject you want to learn from these... " +
                    "sinhala, english, maths, science, history, geography, information technology ",
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == RQ_SPEECH_REC && resultCode == Activity.RESULT_OK) {
            ...
            if (speechResult == "sinhala") {
                val intent = Intent(this@SubjectsMidGrades, PlayContent::class.java)
                ...
                val intent = Intent(this@SubjectsMidGrades, Categories::class.java)
                startActivity(intent)

            }else if (speechResult == "user room") {

                val intent = Intent(this@SubjectsMidGrades, UserRoom::class.java)
                startActivity(intent)
